 ...
 */
function findClickPoint(page: Page, color: Rgb, margin: number, xMaxFrac = 0.7) {
...
function pixelAt(page: Page, point: { x: number; y: number }): Promise<Rgb | null> {
...
function isNear(px: Rgb, target: Rgb, tol: number): boolean {
  return (
